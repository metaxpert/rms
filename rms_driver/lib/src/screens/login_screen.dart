...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      nav.pushReplacement(MaterialPageRoute(builder: (_) => const DeliveriesScreen()));
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Driver', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700)),
                const Text('Your delivery runs', style: TextStyle(color: Colors.black54)),
