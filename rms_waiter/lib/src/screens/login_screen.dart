...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (!mounted) return;
      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const TablesScreen()));
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Waiter', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700)),
                const Text('Sign in to take orders', style: TextStyle(color: Colors.black54)),
