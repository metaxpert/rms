...
/// A small pulsing green "live" indicator for the realtime dashboard.
      ...
      children: [
        FadeTransition(
          ...
          child: Container(
            width: 8,
            height: 8,
            decoration: const BoxDecoration(color: Color(0xFF1B7A4B), shape: BoxShape.circle),
          ),
        ),
        const SizedBox(width: 5),
        const Text('live', style: TextStyle(color: Color(0xFF1B7A4B), fontSize: 12, fontWeight: FontWeight.w600)),
      ],
    );
  }
}
